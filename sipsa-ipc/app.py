...
def _check_auth(credentials: HTTPBasicCredentials = Depends(security)):
    """Valida usuario y contraseña contra las variables SIPSA_IPC_USER / SIPSA_IPC_PASS."""
    expected_user = os.environ.get("SIPSA_IPC_USER", "sipsa_ipc")
...
async def run_pipeline(
    ...
    _update_params({
        "archivo_entrada":     f"data/01_raw/{archivo}",
